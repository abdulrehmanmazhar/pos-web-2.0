...
import { useAddOrderPaymentMutation } from "../redux/slices/orderApiSlice";

const AddPaymentModal: React.FC<{ toggleModal: () => void }> = ({ toggleModal, setPayment, ok, target}) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
                  ...
                  try {
                    const result = await addPayment({...values, id:target});
                    if(result.error){
