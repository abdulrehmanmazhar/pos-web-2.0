...
import { useAddCustomerMutation } from "../redux/slices/customersApiSlice";
import { toast } from "react-toastify";
interface AddCustomerModalProps {
  toggleModal: () => void;
}

const AddCustomerModal: React.FC<AddCustomerModalProps> = ({ toggleModal }) => {
  ...
  const [addCustomer,{data, error, isError, isLoading}] = useAddCustomerMutation()
