...
import { useAddProductMutation, useRestockProductMutation } from '../redux/slices/inventoryApiSlice';
...
const RestockInventoryModal: React.FC<RestockInventoryModalProps> = ({ toggleModal, details }) => {
  const { id, name, category } = details;
  const [restockProduct, { data, error, isError, isLoading }] = useRestockProductMutation();
