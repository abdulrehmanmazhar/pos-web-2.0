...
const DeleteModal: React.FC<DeleteModalProps> = ({ message, toggleModal, ok }) => {
  const deleteHandler = () => {
    ok();
    toggleModal()
  }
  return (
    <>
      <div
        id="popup-modal"
        tabIndex={-1}
        className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center w-full h-full"
      >
